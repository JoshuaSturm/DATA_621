...
The dataset has `r ncol(ins.training) - 3` predictor variables, and `r nrow(ins.training)` cases. Each case represents a automotive insurance policy holder. We have a sufficiently large sample size to perform regression analysis on the data.
